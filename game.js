...
const enemyDatabase = {
    ...
    "tranquailizer": { name: "Tranquailizer", type: "Advanced", health: 100, waves: 8, encounter: "Wave 2 epilogue" },
    ...
    "emplacement": { name: "Emplacement", type: "Mech", health: 350, waves: 14, encounter: "Wave 7 siege" },
    "combatant": { name: "Combatant", type: "Elite Fodder", health: 100, waves: 10, encounter: "Wave 1 siege" },
    "informant": { name: "Informant", type: "Elite Fodder", health: 150, waves: 6, encounter: "Wave 5 siege" },
    "confidant": { name: "Confidant", type: "Elite Fodder", health: 200, waves: 3, encounter: "Wave 8 siege" },
    "agitator": { name: "Agitator", type: "Elite Fodder", health: 300, waves: 6, encounter: "Wave 5 siege" },
    "fuel tank (agitator)": { name: "Fuel Tank (Agitator)", type: "Elite Fodder", health: 200, waves: 6, encounter: "Wave 5 siege" },
    "agreement": { name: "Agreement", type: "Elite Fodder", health: 150, waves: 5, encounter: "Wave 4 siege" },
    "jagant": { name: "Jagant", type: "Elite Fodder", health: 200, waves: 3, encounter: "Wave 8 siege" },
    "jagant bomb": { name: "Jagant Bomb", type: "Elite Fodder", health: 1000, waves: 3, encounter: "Wave 8 siege" },
    "bombardier": { name: "Bombardier", type: "Elite Advanced", health: 300, waves: 4, encounter: "Wave 7 siege" },
    ...
    "lelantos": { name: "Lelantos", type: "Boss", health: 380, waves: 14, encounter: "Wave 3 siege" },
    "gaia": { name: "Gaia", type: "Boss", health: 775, waves: 12, encounter: "Wave 6 siege" },
    "escort shielder": { name: "Escort Shielder", type: "Elite Fodder", health: 300, waves: 12, encounter: "Wave 6 siege" },
    "shield": { name: "Shield", type: "Elite Fodder", health: 350, waves: 12, encounter: "Wave 6 siege" },
    ...
    "rocket pods": { name: "Rocket Pods", type: "Boss", health: 150, waves: 12, encounter: "Wave 6 siege" },
    ...
    "dreadnought": { name: "Dreadnought", type: "Boss", health: 16000, waves: 1, encounter: "Wave 10 siege" },
...
function submitGuess() {
    ...
    function createEncounterCell(guessedEncounter, targetEncounter, threshold) {
        ...
        // Map the array to lower case to eliminate "Sandbox" vs "sandbox" issues
